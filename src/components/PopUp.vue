<template>
    <div class="fixed z-10 inset-0 overflow-y-auto flex justify-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <input type="password" placeholder="Old Password" v-model="oldPassword" class="w-full px-3 py-2 placeholder-gray-500 border rounded-md">
                                <input type="password" placeholder="New Password" v-model="newPassword" class="w-full px-3 py-2 placeholder-gray-500 border rounded-md mt-2">
                            </div>
                        </div>
                    </div>
                </div>
