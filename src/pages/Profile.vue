      ...
      <div class="bg-cover bg-no-repeat h-[30vh] mb-12 relative"
        ...
        <div class="flex justify-center absolute inset-x-0 -bottom-5">
          <div class="w-32 h-32 md:w-48 md:h-48 lg:w-48 lg:h-48 relative">
            <img src="https://xsgames.co/randomusers/avatar.php?g=female" class="rounded-full border-4 border-gray-200 absolute object-cover w-full h-full" alt="Profile Picture">
          </div>
        </div>
      </div>
      <!-- profile details -->
