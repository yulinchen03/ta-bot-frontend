...
export default {
  getFeedback(courseId, assignmentId, exerciseId) {
    return Api().get(
      `/courses/${courseId}/assignments/${assignmentId}/exercises/${exerciseId}/feedbacks`
    );
  },
  deleteFeedback(courseId, assignmentId, exerciseId, feedbackId) {
    return Api().delete(
      `/courses/${courseId}/assignments/${assignmentId}/exercises/${exerciseId}/feedbacks/${feedbackId}`
    );
  },
